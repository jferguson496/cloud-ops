...
inputs = {
  ...
  project_env  = "staging"
  aws_profile  = "rmc-digital-staging"
  aws_region   = "us-east-1"
  aws_account  = "772628109955"

  vpc_public_cidr_block      = "10.203.4.0/22"
  vpc_private_cidr_block     = "10.202.4.0/22"
  ...
  vpn_connections = {
    main = {
      ...
      vpn_gateway = {
        name            = "RMC-Digital-Staging"
        amazon_side_asn = 65032
      }
      vpn_connection = {
        name = "RMC-Prod-VPC"
        type = "ipsec.1"
    ...
    main = {
      ...
      waf = {
        ...
        internal_service_whitelist = {
          enabled = true
          domain  = "connect-staging.rmcdigital.net"
          ip_list = [
            "18.207.10.253/32", # Regionals VPN public IP
            "34.252.84.235/32", # Tivix VPN proxy
            "4.246.174.46/32", # Regionals AVD Public IP
      ...
      listeners = {
        ...
        https = {
          ...
          default_certificate = "staging.rmcdigital.net"
          extra_certificates  = []
        }
      }
      target_group = {
  ...
  acm_certificates = {
    "staging.rmcdigital.net" = {
       san = [
        "myaccount.staging.rmcdigital.net",
      ]
      r53_zone = "staging.rmcdigital.net"
    },
    "connect-staging.rmcdigital.net" = {
      san      = []
      r53_zone = "connect-staging.rmcdigital.net"
    }
  }
  ...
  rds_instances = {
    rmc-staging = {
      ...
      deletion_protection      = true
      public_access            = false
      custom_cname             = "rds.staging.rmcdigital.net"
      custom_cname_zone        = "staging.rmcdigital.net"
      multi_az                 = false
      cloudwatch_logs          = ["postgresql", "upgrade"]
      vpn_subnet_access        = [        
        {
          description = "RMC VPN traffic"
          source      = ["10.10.60.0/24", "172.28.240.0/23", "10.30.0.0/16", "10.28.12.4/32", "10.51.249.0/26"]
        },
      ]
    },
  }
  ...
  iam_application_roles = {
    rmc-staging = {
      bucket_rw_access = [
        "rmc-digital-staging-public",
        "rmc-digital-staging-private",
        "rmc-digital-staging-reports",
        "rmc-customer-portal-staging-public",
      ],
      bucket_ro_access = [
      ],
      secrets_access = [
  ...
  s3_buckets = {
    "rmc-digital-staging-public" = {
      type       = "public"
      cors_url   = "https://staging.rmcdigital.net"
      versioning = false
      encryption = false
    },
    "rmc-digital-staging-private" = {
    ...
    "rmc-customer-portal-staging-public" = {
      type       = "public"
      cors_url   = "https://staging.portal.rmcdigital.net"
      versioning = false
      encryption = false
    },
  }
